...
export default function AdminPage() {
  ...
  type Proto = { id: string; title: string; image: string; category: string; description: string; techStack: string[]; features: string[]; websiteUrl?: string; createdAt: string };
  ...
  const [form, setForm] = useState({ title: '', image: '', category: 'SaaS', description: '', techStack: '', features: '', websiteUrl: '' });
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setForm({ title: '', image: '', category: 'SaaS', description: '', techStack: '', features: '', websiteUrl: '' });
    setFile(null);
  };
          ...
          <>
            ...
            <Card className="p-4 mb-6">
              ...
              >
                ...
                <div>
                  <label className="text-sm block mb-1">Image (Upload or URL)</label>
                  <div className="flex gap-2">
                    <Input
                      type="file"
                ...
                <div className="md:col-span-2">
                  <Button type="submit" disabled={createProto.isPending || uploading}>
                  ...
                  <tbody>
                    {protos!.map((p) => (
                      <tr key={p.id} className="border-b">
                        ...
                        <td className="py-2 pr-4">
                          {p.websiteUrl ? <a href={p.websiteUrl} target="_blank" rel="noreferrer" className="text-primary hover:underline">Link</a> : '-'}
                        </td>
                          ...
                          <div className="flex gap-2">
                            <Button
                              ...
                              onClick={() => {
                                ...
                                const url = prompt('New website URL', p.websiteUrl || '') ?? (p.websiteUrl || '');
                                if (url !== (p.websiteUrl || '')) updateProto.mutate({ id: p.id, updates: { websiteUrl: url } });
                              }}
                            >Edit</Button>
